/* 
 * File obtained from http://www.iharder.net/current/java/filedrop/
 * 
...
public class FileDrop {
	 ...
	 * @since 1.0
	 */
	public FileDrop(final java.awt.Component c, final javax.swing.border.Border dragBorder,
			final Listener listener) {
		this(null, // Logging stream
				c, // Drop target
	...
	public FileDrop(final java.io.PrintStream out, final java.awt.Component c,
		...
		if (supportsDnD()) { // Make a drop listener
			dropListener = new java.awt.dnd.DropTargetListener() {
				...
				public void dragOver(java.awt.dnd.DropTargetDragEvent evt) { // This is called continually as
																				// long as the mouse is
